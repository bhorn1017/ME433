...
void initSPI() {
    ...
    TRISBbits.TRISB15 = 0; //initialize as output
    LATBbits.LATB15 = 1; //initialize as high
    
    // set B12 -> DC (data control), initialize Low
    TRISBbits.TRISB12 = 0; //initialize as output
    LATBbits.LATB12 = 0; //initialize as low
